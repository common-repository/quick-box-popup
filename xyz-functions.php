...
function xyz_qbx_links($links, $file) 
{
	...
	if ($file == $base) 
	{
		$links[] = '<a href="http://help.xyzscripts.com/docs/quick-box-popup/faq/"  title="FAQ">FAQ</a>';
		$links[] = '<a href="http://help.xyzscripts.com/docs/quick-box-popup/"  title="Read Me">README</a>';

...
function qbx_menu()
{
    add_menu_page('Quick Box Popup Settings', 'XYZ Quick Box', 'manage_options', 'quickbox-settings', 'qbx_settings',plugin_dir_url(XYZ_QBX_PLUGIN_FILE).'images/quickbox-popup.png');
...
function xyz_qbx_admin_style()
{
	...
	wp_register_script( 'xyz_notice_script_qbx', plugins_url('quick-box-popup/js/notice.js') );
	wp_enqueue_script( 'xyz_notice_script_qbx' );
}

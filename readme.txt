=== Quick Box - Onclick Popup Notification Box===
Contributors: f1logic
Donate link: http://xyzscripts.com/donate/
Tags: onclick popup, quick popup, quick box, quick popup box, quick box popup, on click popup, on click quick popup, custom message popup, popup message on pages, popup message, popup, popup box
...
A quicklook into Quick Box - Onclick Popup Notification Box

    ★ Create a light weight onclick popup box
...
Quick Box - Onclick Popup Notification Box is developed and maintained by [XYZScripts](http://xyzscripts.com/ "xyzscripts.com"). For any support, you may [contact us](http://xyzscripts.com/support/ "XYZScripts Support").

★ [Quick Box - Onclick Popup Notification Box User Guide](http://help.xyzscripts.com/docs/quick-box-popup/ "Quick Box - Onclick Popup Notification Box User Guide")
★ [Quick Box - Onclick Popup Notification Box FAQ](http://help.xyzscripts.com/docs/quick-box-popup/faq/ "Quick Box - Onclick Popup Notification Box Popup FAQ")

== Installation ==

★ [Quick Box - Onclick Popup Notification Box User Guide](http://help.xyzscripts.com/docs/quick-box-popup/ "Quick Box - Onclick Popup Notification Box User Guide")
★ [Quick Box - Onclick Popup Notification Box FAQ](http://help.xyzscripts.com/docs/quick-box-popup/faq/ "Quick Box - Onclick Popup Notification Box FAQ")

1. Extract `quick-box-popup.zip` to your `/wp-content/plugins/` directory.
2. In the admin panel under plugins activate Quick Box - Onclick Popup Notification Box.
3. You can configure the settings from XYZ Quick Box menu.
...
= 1. What is a "Quick Box - Onclick Popup Notification Box" ? =

A Quick Box - Onclick Popup Notification Box is used to display any content inside a popup within a webpage. It is normally used to show subscription forms, contact forms, promotions, etc.

= 2. The Quick Box - Onclick Popup Notification Box plugin is not working properly =

Please check the wordpress version you are using. Make sure it meets the minimum version recommended by us. Make sure all files of the `Quick Box - Onclick Popup Notification Box` plugin are uploaded to the folder `wp-content/plugins/`
...
1. Sample Quick Box - Onclick Popup Notification Box which has a feedback form.
...
= 1.2 =
* Responsive quick box
* Fixed a few bugs

= 1.1.1 =
* Fix for enable popup issue.
...
= 1.0.1 =
If you have had issues with shortcode, you must do this upgrade.
